        ...
        <View style={styles.detailsBox}>
          ...
          <View style={styles.headerRow}>
            <View style={styles.refContainer}>
              ...
              <Text style={styles.refText}>{`Réf: ${data?.id || 'N/A'}`}</Text>
            </View>

          
            <View style={styles.priceBadge}>
              <Text style={styles.priceText}>{`${data?.price} DH`}</Text>
            </View>
          </View>

          <Text style={styles.carName} numberOfLines={1}>
            {data?.model + ' ' + data?.brands}
          </Text>
          ...
          <View style={styles.metaRow}>
            <View style={styles.metaItem}>
              ...
              <Text style={styles.metaText} numberOfLines={1}>{data?.SellerName}</Text>
            </View>

            <View style={styles.metaItem}>
              <MapPinned opacity={0.8} size={16} color={COLORS.black_lite}/>
              <Text style={styles.metaText} numberOfLines={1}>{data?.ville}</Text>
            </View>
          </View>
