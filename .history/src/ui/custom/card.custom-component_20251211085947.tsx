...
const Card: React.FC<CardProps> = ({ data }) => {
  ...
  const statusTheme = getStatusColors(data?.status)
  console.log(`${HOST_NAME}${data.imageUrl}`)
  return (
    <View style={styles.card}>
      <View style={styles.cardContent}>
        ...
        <Image 
          style={styles.image} 
          defaultSource={PLACEHOLDER_CAR}
          source={{uri:`${HOST_NAME}${data.imageUrl}`}} 
        />
        ...
        <View style={styles.detailsBox}>
          ...
          <View style={styles.headerRow}>
            <View style={styles.refContainer}>
              ...
              <Text  numberOfLines={1} style={styles.refText}>{`Réf: ${data?.ref || 'N/A'}`}</Text>
            </View>
