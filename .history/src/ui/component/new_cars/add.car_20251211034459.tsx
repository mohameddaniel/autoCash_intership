...
const AddCarScreen = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if(!city)  tempErrors.email = "la ville est requise";
    if(!address)  tempErrors.email = "la adress est requise"
    if(!monthId)  tempErrors.email = "le mois est requise"
    if(!km)  tempErrors.email = "kelimétrage est requise"
