...
import { ScrollView, StyleSheet, Text, TouchableOpacity, View, Alert, Platform, KeyboardAvoidingView, ToastAndroid } from 'react-native';
...
const AddCarScreen = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (Object.keys(tempErrors).length > 0) {
      ...
      isValid = false;
      ToastAndroid.showWithGravityAndOffset( "Veuillez remplir tous les champs obligatoires.",ToastAndroid.SHORT,ToastAndroid.TOP);
    } else {
        setErrors({});
    }
    return isValid;
