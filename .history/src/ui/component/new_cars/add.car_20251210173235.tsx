...
import { SilerTypeData } from '../../../store/data/siller.type'
...
const AddCarScreen = () => {
  ...
  const [price, setPrice] = useState<number | null>(330000);
      ...
      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.inputContainer}>
         ...
         <View style={styles.inputContainer}>
          <Text style={styles.inputLabel}>Ville</Text>
          <SmartCombobox
            data={['El jadida','Rabat','Casa blanca']}
            value={city}
            onChange={setCity}
          />
        </View>
        ...
        <TouchableOpacity
           onPress={() => {
            ...
            dispatch(registerSequenceAction())
           }}
