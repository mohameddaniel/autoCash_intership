...
import { fetchUserAction } from '../../../store/redux/features/fetch/fetchUser/fetch.user'
import { fetchModel } from '../../../store/redux/features/fetch/fetchModel/fetch.model'
import { fetchBrandAction } from '../../../store/redux/features/fetch/fetchBrand/Brand.fetch'        await dispatch(fetchCarsAction());
...
const HomeScreen = () => {
   ...
   useEffect(() => {
    (async () => {
        ...
        await dispatch(fetchModel(1));
        await dispatch(fetchBrandAction());
        await dispatch(fetchUserAction(1));
    })();
    }, []);
