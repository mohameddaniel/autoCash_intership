        ...
        <View style={styles.detailsBox}>
          ...
          <View style={styles.headerRow}>
            <View style={styles.refContainer}>
              <SearchCode color={COLORS.Bright_Royal_Blue} size={20} />
              <Text style={styles.refText}>{`Réf: ${data?.ref}`}</Text>
            </View>

          
            <View style={styles.priceBadge}>
              <Text style={styles.priceText}>{`${data?.prix} DH`}</Text>
            </View>
          </View>
          ...
          <View style={styles.metaRow}>
            <View style={styles.metaItem}>
              ...
              <Text style={styles.metaText} numberOfLines={1}>{data?.nomVendeur}</Text>
            </View>
